...
return {
  ...
  edn = { "clojure_lsp" },
  eelixir = { "elixirls", "expert", "htmx", "lexical", "nextls", "snyk_ls", "snyk_ls", "tailwindcss" },
  ejs = { "htmx", "tailwindcss", "unocss" },
  elixir = { "ast_grep", "elixirls", "expert", "htmx", "lexical", "nextls", "snyk_ls", "snyk_ls", "tailwindcss" },
  elm = { "elmls" },
  ...
  javascript = { "ast_grep", "biome", "codebook", "cssmodules_ls", "denols", "dprint", "ember", "eslint", "glint", "harper_ls", "htmx", "lwc_ls", "oxfmt", "oxlint", "quick_lint_js", "snyk_ls", "snyk_ls", "tailwindcss", "ts_ls", "tsgo", "unocss", "vtsls" },
  ["javascript.glimmer"] = { "ember", "glint" },
  javascriptreact = { "ast_grep", "biome", "codebook", "cssmodules_ls", "denols", "dprint", "emmet_language_server", "emmet_ls", "eslint", "graphql", "htmx", "oxfmt", "oxlint", "tailwindcss", "ts_ls", "tsgo", "unocss", "vtsls" },
  jinja = { "jinja_lsp" },
  jq = { "jqls" },
  ...
  python = { "ast_grep", "basedpyright", "codebook", "djls", "dprint", "harper_ls", "jedi_language_server", "pylsp", "pylyzer", "pyre", "pyrefly", "pyright", "ruff", "snyk_ls", "snyk_ls", "ty", "zuban" },
  qml = { "qmlls" },
  qmljs = { "qmlls" },
  ...
  typescript = { "angularls", "ast_grep", "biome", "codebook", "cssmodules_ls", "denols", "dprint", "ember", "eslint", "glint", "harper_ls", "htmx", "oxfmt", "oxlint", "quick_lint_js", "snyk_ls", "snyk_ls", "tailwindcss", "ts_ls", "tsgo", "unocss", "vtsls" },
  ["typescript.glimmer"] = { "ember", "glint" },
  typescriptreact = { "angularls", "ast_grep", "biome", "codebook", "cssmodules_ls", "denols", "dprint", "emmet_language_server", "emmet_ls", "eslint", "graphql", "harper_ls", "htmx", "oxfmt", "oxlint", "tailwindcss", "ts_ls", "tsgo", "unocss", "vtsls" },
  typespec = { "tsp_server" },
